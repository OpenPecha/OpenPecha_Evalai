...
__all__ = ["UserCreate", "UserRead", "UserUpdate", "ChallengeCreate", "ChallengeRead", "SubmissionCreate", "SubmissionRead", "CategoryCreate", "CategoryRead", "ModelCreate", "ModelRead", "ResultCreate", "ResultRead"]